...
def obdelaj_model_letala(vsebina, podatki_nesrece):
    # Najprej najdi celoten <td class="desc"> za Type:
    ...
    if model_letala == "Ni podatka":
        # Če ni linka, odstrani HTML oznake (poenostavljeno)
